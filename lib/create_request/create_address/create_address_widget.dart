...
import '/create_request/address_from_user/address_from_user_widget.dart';
...
import 'create_address_model.dart';
export 'create_address_model.dart';

class CreateAddressWidget extends StatefulWidget {
  const CreateAddressWidget({Key? key}) : super(key: key);

  @override
  _CreateAddressWidgetState createState() => _CreateAddressWidgetState();
}

class _CreateAddressWidgetState extends State<CreateAddressWidget> {
  late CreateAddressModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateAddressModel());

    _model.textController1 ??= TextEditingController();
    _model.domController ??= TextEditingController();
                            ...
                            return FlutterFlowDropDown<String>(
                              controller: _model.dropDownValueController ??=
                                ...
                                _model.dropDownValue ??=
                                    _model.street != null && _model.street != ''
                                        ? _model.street
                                        : '',
                              ),
                            ...
                            await showModalBottomSheet(
                              ...
                              builder: (context) {
                                return Padding(
                                  ...
                                  child: AddressFromUserWidget(),
                                );
                              },
                            ).then((value) =>
                                setState(() => _model.street = value));
