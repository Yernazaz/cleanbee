...
import 'choose_size_model.dart';
export 'choose_size_model.dart';
...
class _ChooseSizeWidgetState extends State<ChooseSizeWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChooseSizeModel());
  }
                      ...
                      onTap: () async {
                        ...
                        if (widget.aptType?.id == 'Z3sYDNdXnLQD0ggwfnkM') {
                          ...
                          context.pushNamed(
                            ...
                            queryParameters: {
                              'aptType': serializeParam(
                                columnSizesRecord.parentReference,
                                ParamType.DocumentReference,
                              ),
                              'aptSize': serializeParam(
                                columnSizesRecord.reference,
