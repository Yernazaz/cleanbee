                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: StreamBuilder<HouseTypeRecord>(
                      stream: HouseTypeRecord.getDocument(widget.aptType!),
                    ...
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            0.0, 12.0, 0.0, 12.0),
                        child: Text(
                          'Общая стоимость работы: ${valueOrDefault<String>(
                            formatNumber(
                              FFAppState().totalPrice,
                              formatType: FormatType.decimal,
                              decimalType: DecimalType.automatic,
                        ...
                        if (_model.address == null) {
                          ...
                          if (_model.sd == null) {
                            ...
                            var requestsRecordReference =
                                RequestsRecord.createDoc(currentUserReference!);
