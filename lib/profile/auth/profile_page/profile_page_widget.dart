                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  FFButtonWidget(
                                    onPressed: () async {
                                      context.pushNamed('CreateStreet');
                                    },
                                    text: 'Адреса',
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  FFButtonWidget(
                                    onPressed: () async {
                                      context.pushNamed('CreateService');
                                    },
                                    text: 'Доп Услуги',
                                    options: FFButtonOptions(
                                      width: 150.0,
                              ...
                              builder: (context) =>
                                ...
                                stream: queryAdressesRecord(
                                  ...
                                  queryBuilder: (adressesRecord) =>
                                      adressesRecord.orderBy('address'),
                                ),
                                builder: (context, snapshot) {
                                  ...
                                  List<AdressesRecord>
                                      columnAdressesRecordList = snapshot.data!;
                                                ...
                                                Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 0.0, 0.0, 5.0),
                                                  child: Text(
                                                    'Дом: ${columnAdressesRecord.houseNumber}${columnAdressesRecord.entrance != null && columnAdressesRecord.entrance != '' ? '| Подъезд: ${columnAdressesRecord.entrance}' : ''}${columnAdressesRecord.aptNumber != null && columnAdressesRecord.aptNumber != '' ? ' | Квартира: ${columnAdressesRecord.aptNumber}' : ''}',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium,
                                                  ),
