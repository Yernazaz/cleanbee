...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFD58E00);
  late Color secondary = const Color(0xFFFF3B30);
  late Color tertiary = const Color(0xFF34C759);
  late Color alternate = const Color(0xFF3C00FF);
  ...
  late Color accent3 = const Color(0xFFFF3A2D);
  ...
  late Color info = const Color(0xFF5AC8FA);
}
